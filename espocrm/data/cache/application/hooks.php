...
return [
  'CCondominium' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\CCondominium\\SetRecordId',
        'order' => 9
      ]
    ]
  ],
  'RealEstateProperty' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\RealEstateProperty\\ConsolidaAdicionais',
        'order' => 9
      ],
      1 => [
        'className' => 'Espo\\Custom\\Hooks\\RealEstateProperty\\CopiaEnderecoCondominio',
        'order' => 9
      ],
      2 => [
        'className' => 'Espo\\Custom\\Hooks\\RealEstateProperty\\SetRecordId',
        'order' => 9
      ],
      3 => [
        'className' => 'Espo\\Modules\\RealEstate\\Hooks\\RealEstateProperty\\SetValues',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'RealEstateRequest' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\RealEstateRequest\\CopiaEnderecoCondominio',
        'order' => 9
      ],
      1 => [
        'className' => 'Espo\\Modules\\RealEstate\\Hooks\\RealEstateRequest\\SetValues',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'Opportunity' => [
    'afterSave' => [
      ...
      2 => [
        'className' => 'Espo\\Modules\\RealEstate\\Hooks\\Opportunity\\RealEstate',
        'order' => 16
      ]
    ],
    'beforeSave' => [
