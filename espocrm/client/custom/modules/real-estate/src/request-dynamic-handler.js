...
Espo.define('real-estate:request-dynamic-handler', 'dynamic-handler', function (Dep) {

    return Dep.extend({

        init: function () {
            this.onChangePropertyType(this.model, this.model.get('propertyType'));
        },

        onChangePropertyType: function (model, value) {
            var type = value;
